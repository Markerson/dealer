		...
		<div class="grid-x grid-padding-x">
			...
			<div class="large-11 cell">	
				<div class="grid-container" style="padding-left:0rem; padding-right:0rem;">
					<div class="grid-x grid-padding-x repeater_3_container">
						<div class="large-12 cell repeater_3_1">
			...
			<div class="large-1 cell icon-repeat">
				<img class="repeater_3_remove" src="{{ asset('svgs/ic_remove_small.svg') }}">
				<img class="repeater_3_add" src="{{ asset('svgs/ic_add_small.svg') }}">
			</div>
			<div class="large-12 cell">
